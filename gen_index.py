...
<h2>円安の影響の裏付け系列(為替・交易条件・物価)</h2>
<img src="japan_macro.png" alt="為替レート・交易条件・消費者物価の推移">
<div class="table-wrap">{table_html(macro)}</div>
<p class="note">出所: 世界銀行 WDI (為替: PA.NUS.FCRF / 交易条件: TT.PRI.MRCH.XD.WD、2005年以降のみ公表 / 物価: FP.CPI.TOTL.ZG) / <a href="japan_macro.csv">CSVをダウンロード</a></p>
<ul>
...
<p class="note">※ 実質賃金の公式系列(厚生労働省「毎月勤労統計」など)は世界銀行・IMFのデータソースに含まれないため、ここでは物価上昇率を代理系列として示している。</p>
...
<p class="note">※ この考察のうち為替・交易条件・物価に関する記述は、上記「裏付け系列」のデータで確認できる。実質賃金の公式系列は世界銀行・IMFに含まれないため、消費者物価上昇率を代理系列として使用している。</p>
