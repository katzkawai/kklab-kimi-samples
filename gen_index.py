...
macro = pd.read_csv("japan_macro.csv")
...
<h2>円安の影響の裏付け系列(為替・交易条件・物価・実質賃金)</h2>
<img src="japan_macro.png" alt="為替レート・交易条件・消費者物価・実質賃金の推移">
<div class="table-wrap">{table_html(macro)}</div>
<p class="note">出所: 世界銀行 WDI (為替: PA.NUS.FCRF / 交易条件: TT.PRI.MRCH.XD.WD、2005年以降のみ公表 / 物価: FP.CPI.TOTL.ZG)、厚生労働省「毎月勤労統計調査」長期時系列表(実質賃金指数: 現金給与総額・事業所規模30人以上・2020年=100、e-Stat経由) / <a href="japan_macro.csv">CSVをダウンロード</a></p>
<ul>
<li><strong>為替レート</strong>: 2012年の80円/ドルから2024年の151円/ドルへ約90%の円安。ドル建てGNPの減少とほぼ一致する</li>
<li><strong>交易条件</strong>: 2022年に79.3(2015年=100)まで悪化。輸入価格の上昇が輸出価格を大きく上回り、実質所得が海外へ流出したことを示す</li>
<li><strong>消費者物価</strong>: 2022年に+2.5%、2023年に+3.3%と2%を超えるインフレが定着。輸入物価上昇が家計の実質購買力を侵食したことを裏付ける</li>
<li><strong>実質賃金</strong>: 1997年のピーク(113.0)から長期低落傾向にあり、2023年には前年比-2.0%と大幅な実質目減り。2025年の指数98.0はピーク時より約13%低く、円安インフレによる家計負担の増大を直接示している</li>
</ul>
...
<p class="note">※ この考察のうち為替・交易条件・物価・実質賃金に関する記述は、上記「裏付け系列」のデータで確認できる(実質賃金は厚生労働省「毎月勤労統計調査」より取得)。</p>
